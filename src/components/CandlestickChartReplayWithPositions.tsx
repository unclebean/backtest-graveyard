      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between bg-[#151924] border-b border-white/10 text-white px-4 py-2 z-10 gap-4 shrink-0 sm:h-[52px]">
        <div className="flex items-center gap-4 w-full sm:w-auto">
          ...
          <div className="flex items-center gap-2 sm:gap-3 shrink-0">
            ...
            <div className="flex items-center gap-1.5 bg-red-500/10 border border-red-500/20 px-2 py-0.5 rounded-md text-red-400 shrink-0">
            ...
            <div className="flex items-center gap-1.5 bg-white/5 border border-white/10 px-2 py-0.5 rounded-md shrink-0">
